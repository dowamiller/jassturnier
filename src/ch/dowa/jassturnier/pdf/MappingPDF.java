...
public class MappingPDF {
    ...
    public MappingPDF ( ArrayList<String> names, ArrayList<String> tables, ArrayList<String> seats, String header){
        this.names = names;
        this.header = header;
        this.tables = tables;
        this.seats = seats;
    ...
    public PdfPTable createTable() throws DocumentException {
        ...
        table.addCell(createLabelCell("Tisch:"));
        table.addCell(createLabelCell("Platz:"));
 
        //-----------------Table Cells Label/Value------------------
 
        for(int i = 0;i<names.size() ;i++){
            table.addCell(Style.setAlternateRowColor(createNameCell(names.get(i)), i));
            table.addCell(Style.setAlternateRowColor(createIntegerCell(tables.get(i)), i));
            table.addCell(Style.setAlternateRowColor(createIntegerCell(seats.get(i)), i));
        }
        return table;
    }
